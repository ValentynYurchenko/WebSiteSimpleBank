...
////////////////////////////////////////////////////////////// Lifecycle DOM Events - события жизненного цикла веб-страницы:

// 1) содержимое DOM загружено - это событие происходит после того как HTML документ полностью распознан и преобразован в дерево DOM, а также загружены и выполнены все скрипты. Это событие не будет ждать пока загрузяться какие-то сторонние элементы (например изображения).
// когда в нашем HTML документе тег скрипт находиться в самом конце, то нам не нужно слушать это событие (DOMContentLoaded), потому что браузер будет искать наш js код только после того как будет распознан весь предыдущий HTML код.

document.addEventListener('DOMContentLoaded', function (e) {
  console.log('Дерево DOM создано!', e);
});

// 2) событие load - когда все элементы веб-страницы полностью загружены (в том числе внешние файлы такие как изображения и стили CSS).

window.addEventListener('load', function (e) {
  console.log('Страница полностью загружена!', e);
});

// 3) beforeunload - событие перед выходом с веб-страницы

// window.addEventListener('beforeunload', function (e) {
//   e.preventDefault();
//   console.log(e);
//   e.returnValue = ''; // для получения предупреждающего сообщения при попытке закрытия веб-страницы.
// });
